...
const analyzing = async (targetImage: File): Promise<string> => {
  ...
  const prompt = `
    ...
    반환 양식:
    { "tags": ["태그1", "태그2", "태그3", ..., "태그10"], "themeColor": "#000000", "feedback": { "detail": "이미지에 대한 자세한 피드백", "summary": {"good": "이미지에서 좋았던 부분", "improve": "해당 이미지에서 아쉬웠던, 다음 작품 활동에서 참고할만한 내용"} } }
    ...
    8. 분위기를 나타내는 태그는 아래 moodTags 중에서 가장 적합한 하나만 골라서 포함하세요.
      "moodTags": [
    ...
    11. 이미지의 배경이나 장소에 대한 태그를 하나 이상 tags에 포함하세요.
